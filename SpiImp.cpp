...
void CSpiImp::OnRspTradeAccounts( int nRequest, CRspErrorField *pError, bool bLast, COXRspTradeAcctField *pField )
{
	cout<<"OnRspTradeAccounts::" 
		<< " Request id: "<< nRequest 
		<< " Last is  " <<bLast
		<<endl; 
...
void CSpiImp::OnRspQueryOrders( int nRequest, CRspErrorField *pError, bool bLast, COXRspOrderField *pField )
{
...
void CSpiImp::OnRspQueryBalance( int nRequest, CRspErrorField *pError, bool bLast, COXRspBalanceField *pField )
{
...
void CSpiImp::OnRspQueryPositions( int nRequest, CRspErrorField *pError, bool bLast, COXRspPositionField *pField )
{
...
void CSpiImp::OnRspQueryFilledDetails( int nRequest, CRspErrorField *pError, bool bLast, COXRspFilledDetailField *pField )
{
...
void CSpiImp::OnOrderTicketError( int nRequest, CRspErrorField *pError )
{
...
void CSpiImp::OnOrderTicketAck( int nRequest, COXRspOrderTicketField *pField )
{
...
void CSpiImp::OnRspCancelTicketError( int nRequest, CRspErrorField *pError )
{
...
void CSpiImp::OnRtnOrder( COXRtnOrderTicket *pOrderTicket )
{
...
void CSpiImp::OnRtnOrderFilled( COXOrderFilledField *pFilledInfo )
{
...
void CSpiImp::OnRtnCancelRejected( CRspErrorField *pError, COXRtnOrderTicket *pRtnOrderTicket )
{
